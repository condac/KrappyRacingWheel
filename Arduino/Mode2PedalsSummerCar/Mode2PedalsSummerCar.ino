...
#define THROTTLE_MAX 950 // Analog value at maximum position
...
#define BRAKE_MAX 825 // Analog value at maximum position
...
void loop() {
  ...
  cl = limit(cl, 0, 1023);
  Joystick.setRzAxis(cl);

  if (flightmode) {
    th = map(thRaw, THROTTLE_MIN, THROTTLE_MAX,0,511);
    cl = map(clRaw, CLUTCH_MIN, CLUTCH_MAX,0,511);
    
    Joystick.setRxAxis(0);
  
    Joystick.setRzAxis(511-th+cl);
  }
